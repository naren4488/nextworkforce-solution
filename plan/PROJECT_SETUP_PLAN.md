...
### 4.2 Routing (client-side)
- Use **React Router** (or similar) for SPA-style navigation
- Or keep it minimal with conditional rendering and anchor links for a true static site
