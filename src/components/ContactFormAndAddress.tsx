...
export function ContactFormAndAddress({ idPrefix = "contact" }: { idPrefix?: string }) {
      ...
      <div>
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <Label htmlFor={`${idPrefix}-name`} className="text-white/90">
            ...
            <div>
              <Label htmlFor={`${idPrefix}-phone`} className="text-white/90">
            ...
            <div>
              <Label htmlFor={`${idPrefix}-email`} className="text-white/90">
            ...
            <div>
              <Label htmlFor={`${idPrefix}-message`} className="text-white/90">
